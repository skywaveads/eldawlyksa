...
export const getStaticProps: GetStaticProps = async ({ locale = 'ar' }) => {
  ...
  const articles = [
    ...
    { arabicTitle: 'هل تحتاج إلى شاحنة تبريد خاصة؟ متى يجب استئجارها؟', blogUrl: '/blog/when_to_rent_a_refrigerated_truck_in_saudi_arabia', imagePath: '/images/blog/when_to_rent_a_refrigerated_truck_in_saudi_arabia.jpeg' },
    ...
    { arabicTitle: 'خدمة تتبع الشحنات المبردة: كيف تعمل وما فوائدها؟', blogUrl: '/blog/how_cold_chain_tracking_works_and_its_benefits', imagePath: '/images/blog/how_cold_chain_tracking_works_and_its_benefits.jpeg' },
    ...
    { arabicTitle: 'كيف تحافظ شركات النقل المبرد على سلامة المنتجات؟', blogUrl: '/blog/how_companies_ensure_safe_cold_chain_delivery', imagePath: '/images/blog/how_companies_ensure_safe_cold_chain_delivery.jpeg' },
